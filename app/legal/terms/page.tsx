...
export const metadata = generateMetadata({
    ...
    description: 'Terms and Conditions for Your Name — portfolio site. Rules for using this website.',
    url: '/legal/terms',
            ...
            <article className="prose prose-lg dark:prose-invert">
                ...
                <section>
                    ...
                    <p>
                        ...
                        republish or redistribute content without permission. Code snippets are generally provided under MIT unless
                        otherwise noted — verify license notes near each snippet.
                    </p>
                </section>
                <section>
                    <p>
                ...
                <section>
                    ...
                    <p>
                        The Site may link to external websites. Links are provided for convenience; we are not responsible for their
                        content and linking does not imply endorsement.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        These Terms are governed by the laws of the country where the Site owner is resident. If you are unsure,
                        contact  <a href={`mailto:${appConfig.emails[0]}`}>{appConfig.emails[0]}</a> for clarification.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        We may modify these Terms. Continued use after changes constitutes acceptance. Check this page for updates.
                    </p>
                </section>
