...
export default function NotFound() {
  return (
    <PageWrapper>
      <main className="flex flex-col items-center justify-center w-full h-full gap-20 max-h-dvh space-y-4 text-center lg:text-left">
        ...
        <div className="flex gap-3 justify-center lg:justify-start">
          <PreviousPageLink />
          <ButtonTransitionLink rounded="full" variant="dark" href="/">
            <Home />
            Go to Home
          </ButtonTransitionLink>
        </div>
...
export const NotFoundSvg = (props: React.ComponentProps<"svg">) => {
  return (
    <svg
      ...
      aria-label="404"
      {...props}
      className={cn("w-full h-40 my-4 dark:invert", props.className)}
    >
