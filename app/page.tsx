...
import { ButtonLink, ButtonScroll } from "@/components/utils/link";
...
export default function Page() {
  return (
    <Wrapper>
      ...
      <section
        id="hero"
        className="relative flex flex-col-reverse md:grid md:grid-cols-2 items-center justify-between gap-8 px-6 md:px-12 py-40 min-h-dvh max-w-6xl mx-auto w-full"
      >
        ...
        <div className="md:col-span-2 flex justify-center mt-12 md:mt-0 flex-col gap-4 mx-auto items-center">
          ...
          />
          <ButtonScroll variant="ghost" size="icon" rounded="full" className="animate-bounce rotate-180" targetId="about" offset={100}>
            <Icon name="arrow-up" />
          </ButtonScroll>
        </div>
      ...
      {/* About */}
      <section className="w-full backdrop-blur-2xl py-12 px-6 md:px-12" id="about">
        <div className="max-w-4xl mx-auto flex flex-col gap-6 text-center md:text-left">
          <BlurFade delay={BLUR_FADE_DELAY * 2}>
            <h2 className="text-2xl font-semibold">About Me</h2>
          </BlurFade>
          <BlurFade delay={BLUR_FADE_DELAY * 3}>
            <Markdown className="prose dark:prose-invert text-muted-foreground max-w-none">
              {DATA.summary}
            </Markdown>
          </BlurFade>
      ...
      {/* Projects */}
      <section id="projects" className="bg-card/50 w-full py-16 px-6 md:px-12">
