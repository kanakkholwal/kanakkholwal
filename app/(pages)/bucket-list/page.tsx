    ...
    >
      ...
      <div className="pt-4 px-2 pb-2 space-y-2">
        <h3 className={cn(
            ...
            item.completed ? "text-foreground" : "text-muted-foreground group-hover:text-foreground transition-colors"
        )}>
          {item.name}
        </h3>
        ...
        <div className="pt-2 flex items-center justify-between">
           <div className="flex -space-x-2 overflow-hidden">
              ...
              {item.images.slice(1, 4).map((img, idx) => (
                 <div key={idx} className="relative size-6 rounded-full ring-2 ring-background overflow-hidden">
