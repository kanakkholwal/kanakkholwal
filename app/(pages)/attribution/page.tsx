      ...
      <div className="relative z-10 pt-24 md:pt-32 container max-w-7xl mx-auto px-6 md:px-12 pb-24">
        ...
        <div className="text-center space-y-6 mb-20">
          ...
          >
            <Badge
              variant="outline"
              className="px-3 py-1 rounded-full border-indigo-500/20 bg-indigo-500/5 text-indigo-500 backdrop-blur-md"
            >
          ...
          >
            ...
            <br />
            shoulders of
            <span className="text-colorful-titanium italic ml-3">Giants.</span>
          </h1>
          ...
          >
            No code is written in a vacuum. This portfolio exists thanks to the
            open-source community and these brilliant designers.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-muted-foreground mt-2 mb-4 leading-relaxed">
                  I build fast, SEO-optimized, and accessible web experiences.
                  Let{"'"}s create something world-class together.
                </p>
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full bg-background/50 hover:bg-background border-indigo-500/30 hover:border-indigo-500/50"
                  asChild
                >
