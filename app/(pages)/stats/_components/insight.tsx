...
export async function InsightStats({ project }: { project: ProjectConfig }) {
  ...
  return (
    <div className="w-full mt-8 first:mt-0 rounded-xl border border-border bg-card backdrop-blur-sm overflow-hidden hover:border-border/80 transition-colors duration-300">
