        ...
        return (
            <div
                ...
                {(title || description || showTimeRangeFilter) && (
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 @2xl:p-4 pl-3 mt-2">
                        {(title || description) && (
                            <div className="grid flex-1 gap-1">
                                {title && <CardTitle className="font-medium text-sm">{title}</CardTitle>}
