...
export function BentoSkillsSection({categories}: {categories: SkillCategory[]}) {
  return <motion.div
    initial="hidden"
    whileInView="visible"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed max-w-[90%]">{description}</p>
      </div>
