...
export const IconComponentCollection = {
  ...
  "verified:color": (props: React.SVGAttributes<SVGElement>) => (
    <svg
...
export function Icon({
  ...
  // Props were previously dropped here, so every `aria-label` passed to an
  // <Icon> silently never reached the DOM. Forward them, and default to
  // hidden-from-AT unless the caller gives the icon its own accessible name.
  const isLabelled =
