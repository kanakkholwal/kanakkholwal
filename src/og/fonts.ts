...
export const getFonts = cache( async (): Promise<Font[]> => {
  ...
  const spaceGroteskUrl = 'https://cdn.jsdelivr.net/npm/@fontsource/space-grotesk@5.0.1/files/space-grotesk-latin-700-normal.woff';
  const jetBrainsMonoUrl = 'https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.1/files/jetbrains-mono-latin-500-normal.woff';
  const instrumentSerifUrl = 'https://cdn.jsdelivr.net/npm/@fontsource/instrument-serif@5.0.1/files/instrument-serif-latin-400-normal.woff';
