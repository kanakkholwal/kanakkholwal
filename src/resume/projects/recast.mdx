...
order: 2
status: "In Progress"
description: "An open-source screen recorder with cinematic editing built in: cursor smoothing, auto-zoom, and a WebCodecs preview. A free, private Loom alternative."
technologies:
  - "Sveltekit"
  - "Rust"
  - "Tauri"
